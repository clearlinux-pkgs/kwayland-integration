...
Source0  : https://download.kde.org/stable/plasma/5.26.2/kwayland-integration-5.26.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.2/kwayland-integration-5.26.2.tar.xz.sig
...
%prep
%setup -q -n kwayland-integration-5.26.2
cd %{_builddir}/kwayland-integration-5.26.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667247830
mkdir -p clr-build
pushd clr-build
