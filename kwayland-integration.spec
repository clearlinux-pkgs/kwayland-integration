...
Source0  : https://download.kde.org/stable/plasma/5.14.4/kwayland-integration-5.14.4.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.4/kwayland-integration-5.14.4.tar.xz.sig
...
%prep
%setup -q -n kwayland-integration-5.14.4
...
export LANG=C
export SOURCE_DATE_EPOCH=1543394300
mkdir -p clr-build
pushd clr-build
%cmake ..
