...
Version  : 5.27.4
Release  : 78
URL      : https://download.kde.org/stable/plasma/5.27.4/kwayland-integration-5.27.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.4/kwayland-integration-5.27.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.4/kwayland-integration-5.27.4.tar.xz.sig
...
%prep
%setup -q -n kwayland-integration-5.27.4
cd %{_builddir}/kwayland-integration-5.27.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680722256
mkdir -p clr-build
pushd clr-build
