...
Source0  : https://download.kde.org/stable/plasma/5.20.1/kwayland-integration-5.20.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.20.1/kwayland-integration-5.20.1.tar.xz.sig
...
%prep
%setup -q -n kwayland-integration-5.20.1
cd %{_builddir}/kwayland-integration-5.20.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603210263
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwayland-integration-5.20.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/kwayland-integration/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
