...
Version  : 5.15.3
Release  : 12
URL      : https://download.kde.org/stable/plasma/5.15.3/kwayland-integration-5.15.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.15.3/kwayland-integration-5.15.3.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.15.3/kwayland-integration-5.15.3.tar.xz.sig
...
%prep
%setup -q -n kwayland-integration-5.15.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1552409897
mkdir -p clr-build
pushd clr-build
