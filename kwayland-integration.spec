...
Version  : 5.14.0
Release  : 3
URL      : https://download.kde.org/stable/plasma/5.14.0/kwayland-integration-5.14.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.14.0/kwayland-integration-5.14.0.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.0/kwayland-integration-5.14.0.tar.xz.sig
Summary  : No detailed summary available
Group    : Development/Tools
License  : LGPL-2.1
Requires: kwayland-integration-lib
Requires: kwayland-integration-license
Requires: kwayland-integration-data
...
%prep
%setup -q -n kwayland-integration-5.14.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1539115544
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
